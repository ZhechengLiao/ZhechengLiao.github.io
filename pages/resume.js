      ...
      <main>
        ...
        <Flex justifyContent={"center"}>
          <Box px={6} pb={20} w={1000} maxW={"100%"} mt={3} className={"resume-page"}>
            ...
            <ResumeHeading as={"h1"}>Work Expeirence</ResumeHeading>
            {resumeData.expeirence.map((item, index) => (
              <ExperienceItem
            ...
            <ResumeHeading as={"h1"}>Education</ResumeHeading>
            ...
            <ResumeHeading as={"h1"}>Projects</ResumeHeading>
            ...
            <ResumeHeading as={"h1"}>Skills</ResumeHeading>
            <Box px={2} pb={1}>
              {MiscSection.filter((a, i) => i > 0).map((s) => (
                <Text fontSize={13} p={0} key={s.items} fontWeight={200}>
